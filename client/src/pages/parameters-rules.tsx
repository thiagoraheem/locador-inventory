      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          ...
          <div className="border-l-4 border-blue-500 dark:border-blue-400 pl-4">
            ...
            <ul className="list-disc pl-4 space-y-1 dark:text-gray-300">
          ...
          <div className="bg-gray-50 dark:bg-gray-800 p-4 rounded-lg">
            <h4 className="font-semibold mb-3 dark:text-gray-200">Comparação entre as duas primeiras contagens:</h4>
            <div className="space-y-3">
              ...
              <div className="flex items-start gap-2">
                <CheckCircle className="h-4 w-4 text-yellow-600 dark:text-yellow-400 mt-1 flex-shrink-0" />
                <span className="text-sm dark:text-gray-300">
            ...
            <table className="w-full border-collapse border border-gray-300 dark:border-gray-600">
              <thead>
                <tr className="bg-gray-100 dark:bg-gray-700">
                  <th className="border border-gray-300 dark:border-gray-600 p-3 text-left font-semibold">Situação</th>
                  <th className="border border-gray-300 dark:border-gray-600 p-3 text-left font-semibold">Valor Final Considerado</th>
                  <th className="border border-gray-300 dark:border-gray-600 p-3 text-center font-semibold">Divergência?</th>
                </tr>
              </thead>
              <tbody>
                <tr className="dark:bg-gray-800">
                  <td className="border border-gray-300 dark:border-gray-600 p-3">1ª == 2ª == estoque</td>
                  <td className="border border-gray-300 dark:border-gray-600 p-3">Estoque congelado</td>
                  <td className="border border-gray-300 dark:border-gray-600 p-3 text-center">
                    <Badge variant="secondary" className="bg-green-100 dark:bg-green-900 text-green-800 dark:text-green-300">❌ Não</Badge>
                  </td>
                </tr>
                <tr className="bg-gray-50 dark:bg-gray-750">
                  <td className="border border-gray-300 dark:border-gray-600 p-3">1ª ou 2ª == estoque</td>
                  <td className="border border-gray-300 dark:border-gray-600 p-3">Estoque congelado</td>
                  <td className="border border-gray-300 dark:border-gray-600 p-3 text-center">
                    <Badge variant="secondary" className="bg-green-100 dark:bg-green-900 text-green-800 dark:text-green-300">❌ Não</Badge>
                  </td>
                ...
                <tr className="dark:bg-gray-800">
                  <td className="border border-gray-300 dark:border-gray-600 p-3">1ª == 2ª ≠ estoque</td>
                  <td className="border border-gray-300 dark:border-gray-600 p-3">2ª Contagem</td>
                  <td className="border border-gray-300 dark:border-gray-600 p-3 text-center">
                    <Badge variant="secondary" className="bg-yellow-100 dark:bg-yellow-900 text-yellow-800 dark:text-yellow-300">✅ Sim</Badge>
                  </td>
                </tr>
                <tr className="bg-gray-50 dark:bg-gray-750">
                  <td className="border border-gray-300 dark:border-gray-600 p-3">1ª ≠ 2ª ≠ estoque</td>
                  <td className="border border-gray-300 dark:border-gray-600 p-3">3ª Contagem (obrigatória)</td>
                  <td className="border border-gray-300 dark:border-gray-600 p-3 text-center">
                    <Badge variant="secondary" className="bg-red-100 dark:bg-red-900 text-red-800 dark:text-red-300">✅ Sim</Badge>
                  </td>
                </tr>
              </tbody>
            </table>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div>
              <h4 className="font-semibold mb-2 dark:text-gray-200">Dados do Inventário:</h4>
              <ul className="list-disc pl-4 space-y-1 text-sm dark:text-gray-300">
            ...
            <div>
              <h4 className="font-semibold mb-2 dark:text-gray-200">Análise de Divergências:</h4>
              <ul className="list-disc pl-4 space-y-1 text-sm dark:text-gray-300">
          ...
          <Alert>
            <FileText className="h-4 w-4 dark:text-indigo-400" />
            <AlertDescription>
